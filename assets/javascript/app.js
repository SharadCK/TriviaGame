var questions = [
	{
		...
		choice: ["Bois de Boulogne", "Champ de Mars", "Jardin des Plantes", "Parc de Belleville"],
		correctAns: "Champ de Mars"
	}, {
		...
		choice: ["Charlton Heston", "Clark Gable", "Errol Flynn", "Lee Marvin"],
		correctAns: "Charlton Heston"
	}, {
		...
		question: "Air pressure is otherwise known as what?",
		choice: ["Atmospheric weight", "Atmosphere weight", "Atmosphere pressure", "Atmospheric pressure"],
		correctAns: "Atmospheric pressure"
	}, {
...
function checkAnswer(ans) {
	if (ans === questions[qcount].correctAns) {
		...
		$("#display").html("<img src='assets/images/989827.png'>")
		win++
...
function losefunc() {
	...
	$("#display").html("<img src = 'assets/images/No.jpg'>" + "</br><p>" + "The correct answer is: " + questions[qcount].correctAns + "</p>");
	//settimeout to the next question
	setTimeout(nextQuestion, 2000);
}
